                                                                ...
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="woocommerce-Price-amount amount"><span
                                                                            class="woocommerce-Price-currencySymbol">&#2547;&nbsp;</span><?php echo $pricingSection['offerPrice']['amount'] ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="wcf-col-2 col-2">
                                                ...
                                                <div class="woocommerce-additional-fields">
                                                    ...
                                                    <input type="hidden" class="input-hidden _wcf_flow_id"
                                                        ...
                                                        name="_wcf_checkout_id" value="23">
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <td class="product-total">
                                                                <span
                                                                    class="woocommerce-Price-amount amount"><bdi><span
                                                                            class="woocommerce-Price-currencySymbol">&#2547;&nbsp;</span><?php echo $pricingSection['offerPrice']['amount'] ?></bdi></span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    <tfoot>
                                                        ...
                                                        <tr class="order-total">
                                                            ...
                                                            <td><strong><span
                                                                        class="woocommerce-Price-amount amount"><bdi><span
                                                                                class="woocommerce-Price-currencySymbol">&#2547;&nbsp;</span><?php echo $pricingSection['offerPrice']['amount'] ?></bdi></span></strong>
                                                            </td>
                                                        </tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const basePriceStr = <?php echo json_encode($pricingSection['offerPrice']['amount']); ?>;
